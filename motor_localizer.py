...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='\\\\wsl.localhost\\Ubuntu\\home\\adowa\\Documents\\python_works\\unconfeat_MEEG\\motor_localizer.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    left = visual.TextStim(win=win, name='left',
        ...
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color=left_color, colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=0.0);
    middle = visual.TextStim(win=win, name='middle',
        ...
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color=middle_color, colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-1.0);
    right = visual.TextStim(win=win, name='right',
        ...
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color=right_color, colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-2.0);
    ...
    for thisTrial in trials:
        ...
        # keep track of which components have finished
        taskComponents = [left, middle, right]
